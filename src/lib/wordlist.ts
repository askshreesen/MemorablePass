...
// A curated list of 1024 unique, simple English words for human-readable passwords.
// This selection is inspired by BIP39 but optimized for clarity and length.
export const WORDLIST = [
  "abandon", "ability", "able", "about", "above", "absent", "absorb", "abstract", "academic", "accept",
  ...
  "canvas", "canyon", "capable", "capital", "captain", "caption", "car", "carbon", "card", "cargo",
  ...
  "come", "comfort", "comic", "common", "company", "compass", "complete", "confirm", "congress", "connect",
  ...
  "credit", "creek", "crew", "cricket", "crime", "crisp", "critic", "crocodile", "romp", "cross",
  ...
  "denial", "dentist", "deny", "depart", "depend", "deposit", "depth", "deputy", "derive", "desert",
  "design", "desk", "despair", "destroy", "detail", "detect", "device", "devote", "diagram", "dial",
  ...
  "endless", "endorse", "enemy", "energy", "enforce", "engage", "engine", "enjoy", "enlist", "enough",
  ...
  "hard", "harsh", "harvest", "hawk", "hazard", "head", "health", "heart", "heavy", "hedgehog",
  ...
  "naive", "name", "napkin", "narrow", "nasty", "nation", "nature", "near", "nearby", "nearly",
  "neat", "nebula", "neck", "need", "negative", "neglect", "neither", "nephew", "nerve", "nest",
  ...
  "raw", "razor", "ready", "real", "reason", "rebel", "rebuild", "recall", "receive", "recent",
  ...
  "salute", "same", "sample", "sand", "satisfy", "saturn", "sauce", "save", "say", "scale",
  ...
  "strategy", "straw", "street", "stretch", "strong", "struggle", "student", "stuff", "stumble", "style",
  "subject", "submit", "subway", "success", "such", "sudden", "suffer", "sugar", "suggest", "suit",
  "summer", "sun", "sunny", "sunrise", "sunset", "super", "supply", "supreme", "sure", "surface",
  ...
  "toast", "tobacco", "today", "todder", "toe", "together", "toilet", "token", "tomato", "tomorrow",
  ...
  "velvet", "vendor", "venture", "venue", "verb", "verify", "version", "vessel", "veteran", "vibrant",
  ...
  "weasel", "weather", "web", "wedding", "weekend", "weekly", "weigh", "weird", "welcome", "west",
